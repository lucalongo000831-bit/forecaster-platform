...
const defaultIntervals: Record<ChartRange, ChartInterval> = { "1D": "5m", "5D": "15m", "1M": "1h", "3M": "1d", "6M": "1d", YTD: "1d", "1Y": "1d", "3Y": "1d", "5Y": "1wk", "10Y": "1wk", MAX: "1mo" };

function fromDate(range: ChartRange) {
  const now = new Date();
  const days: Record<ChartRange, number> = { "1D": 2, "5D": 7, "1M": 32, "3M": 95, "6M": 185, YTD: 370, "1Y": 367, "3Y": 1_100, "5Y": 1_830, "10Y": 3_660, MAX: 18_250 };
