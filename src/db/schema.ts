...
export const companyAnalysisReports = pgTable("company_analysis_reports", companyResultColumns(), (table) => [index("company_report_time_idx").on(table.instrumentId, table.calculatedAt)]);
