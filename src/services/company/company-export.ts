...
function csvCell(value: unknown) {
  ...
  const spreadsheetSafe = typeof value === "string" && /^[\t\r ]*[=+\-@]/.test(normalized) ? `'${normalized}` : normalized;
