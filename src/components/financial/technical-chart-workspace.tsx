...
export function TechnicalChartWorkspace({ symbol }: { symbol: string }) {
  ...
  const activateTechnicalAlert = async () => {
    ...
    try {
      ...
      setAlertMessage("Server monitoring active. Transitions are evaluated by Kairo with cooldown and internal notification history.");
